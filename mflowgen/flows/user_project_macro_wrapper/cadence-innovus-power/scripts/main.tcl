...
# Ring around mprj macro

set m_ring_width   [expr 2 * $M5_min_width];   # Arbitrary!
set m_ring_spacing [expr 1 * $M5_min_spacing]; # Arbitrary!
...
addRing -nets {vccd1 vssd1} -type block_rings \
       ...
       -layer [list top  $pmesh_top bottom $pmesh_top  \
                    left $pmesh_bot right  $pmesh_bot] \
       -width $m_ring_width                 \
       -spacing $m_ring_spacing             \
       -offset $m_ring_spacing    
deselectAll
