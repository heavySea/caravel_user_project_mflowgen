#=================================================================================
# construct.py for the example caravel user project macro to be used with openlane
#=================================================================================
...
def construct():
  ...
  # Use a slightly different ADK view, where the maximum routing layer is met4
  adk_parameters = {
    'adk'            : 'skywater-130nm',
    'adk_view'       : 'view-openlane'
  }
